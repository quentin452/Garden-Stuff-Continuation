...
public class GuiHandler implements IGuiHandler {
   ...
   public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
      ...
      return tileEntity instanceof TileEntityPotteryTable ? new ContainerPotteryTable(player.inventory, (TileEntityPotteryTable)tileEntity) : null;
   }

   public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
      TileEntity tileEntity = world.getTileEntity(x, y, z);
      return tileEntity instanceof TileEntityPotteryTable ? new GuiPotteryTable(player.inventory, (TileEntityPotteryTable)tileEntity) : null;
   }
}
