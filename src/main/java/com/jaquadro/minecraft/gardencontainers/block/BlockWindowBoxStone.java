...
public class BlockWindowBoxStone extends BlockWindowBox {
    ...
    public static final String[] subTypes = new String[] { "stone_slab", "stone_brick", "mossy_stone_brick",
        "brick_block", "nether_brick", "sandstone" };
    ...
    public IIcon getIcon(int side, int meta) {
        return this.getBlockFromMeta(meta)
            .getIcon(side, this.getMetaFromMeta(meta));
    }
