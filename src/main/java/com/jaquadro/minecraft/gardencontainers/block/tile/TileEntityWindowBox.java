...
public class TileEntityWindowBox extends TileEntityGarden {
    ...
    public boolean isSlotValid(int slot) {
        ...
        if (garden == null) {
            ...
            int facingDir;
            if (garden.getConnectionProfile()
                .isAttachedNeighbor(this.worldObj, this.xCoord, this.yCoord, this.zCoord, dir)) {
            ...
            if (garden.getConnectionProfile()
                .isAttachedNeighbor(this.worldObj, this.xCoord, this.yCoord, this.zCoord, facingDir)) {
