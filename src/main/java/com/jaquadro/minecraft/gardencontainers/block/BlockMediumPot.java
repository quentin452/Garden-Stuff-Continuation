...
public abstract class BlockMediumPot extends BlockGardenContainer implements IChainAttachable {
    ...
    private static final Vec3[] chainAttachPoints = new Vec3[] { Vec3.createVectorHelper(0.16125D, 0.75D, 0.15625D),
        Vec3.createVectorHelper(0.15625D, 0.75D, 0.83875D), Vec3.createVectorHelper(0.84375D, 0.75D, 0.16125D),
        Vec3.createVectorHelper(0.83875D, 0.75D, 0.84375D) };
    ...
    public BlockMediumPot(String blockName) {
        ...
        this.slotProfile = new BlockMediumPot.LocalSlotProfile(
    ...
    private class LocalSlotProfile extends Slot2Profile {
        ...
        private AxisAlignedBB[] mainClippingBounds = new AxisAlignedBB[] {
            AxisAlignedBB.getBoundingBox(0.1875D, 0.0D, 0.1875D, 0.8125D, 0.0625D, 0.8125D),
            AxisAlignedBB.getBoundingBox(0.125D, 0.0625D, 0.125D, 0.875D, 0.125D, 0.875D),
            AxisAlignedBB.getBoundingBox(0.0D, 0.125D, 0.0D, 1.0D, 1.0D, 1.0D) };
