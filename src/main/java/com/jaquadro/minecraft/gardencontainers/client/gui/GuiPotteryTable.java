...
public class GuiPotteryTable extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        String name = this.tilePotteryTable.hasCustomInventoryName() ? this.tilePotteryTable.getInventoryName()
            : I18n.format(this.tilePotteryTable.getInventoryName(), new Object[0]);
