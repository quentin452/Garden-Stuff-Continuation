    ...
    private static class AddOreAction implements IUndoableAction {
        ...
        public void apply() {
            GardenAPI.instance()
                .registries()
                .compost()
                .registerCompostMaterial((String) this.material, new StandardCompostMaterial(this.processTime, 0.125F));
        }
        ...
        public void undo() {
            GardenAPI.instance()
                .registries()
                .compost()
                .removeCompostMaterial(this.material);
        }

        public String describe() {
            return "Adding ore dictionary key '" + this.material
                + "' to compost table with processing time '"
                + this.processTime
                + "'";
        }
    ...
    private static class AddItemAction implements IUndoableAction {
        ...
        public void apply() {
            GardenAPI.instance()
                .registries()
                .compost()
                .registerCompostMaterial(
                    (ItemStack) this.material,
                    new StandardCompostMaterial(this.processTime, 0.125F));
        }
        ...
        public String describe() {
            return "Adding item '" + this.material.getDisplayName()
                + "' to compost table with processing time '"
                + this.processTime
                + "'";
        }
