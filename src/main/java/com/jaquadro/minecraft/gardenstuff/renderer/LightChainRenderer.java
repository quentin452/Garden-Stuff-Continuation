...
public class LightChainRenderer implements ISimpleBlockRenderingHandler {
   ...
   public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
      return block instanceof BlockLightChain ? this.renderWorldBlock(world, x, y, z, (BlockLightChain)block, modelId, renderer) : false;
   }
   ...
   private boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, BlockLightChain block, int modelId, RenderBlocks renderer) {
      ...
      ClientProxy.gardenProxyRenderer.renderWorldBlock(world, x, y, z, ModBlocks.gardenProxy, ModBlocks.gardenProxy.getRenderType(), renderer);
      return true;
   }
