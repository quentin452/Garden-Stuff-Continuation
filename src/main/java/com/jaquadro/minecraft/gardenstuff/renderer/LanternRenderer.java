...
public class LanternRenderer implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        return !(block instanceof BlockLantern) ? false
            : this.renderWorldBlock(world, x, y, z, (BlockLantern) block, modelId, renderer);
    }
        ...
        if (!lowerBlock.isSideSolid(world, x, y - 1, z, ForgeDirection.UP)) {
            ...
            if (upperBlock instanceof IChainSingleAttachable) {
                ...
                if (attach != null && attach != defaultAttachPoint) {
                    ...
                    RenderHelper.instance.renderCrossedSquares(
                        world,
                        ModBlocks.heavyChain,
                        x,
                        y + 1,
                        z,
                        ModBlocks.lightChain.getIcon(0, 4));
                    return;
                }
            }
