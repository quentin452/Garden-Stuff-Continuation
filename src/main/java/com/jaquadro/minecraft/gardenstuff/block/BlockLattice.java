...
public abstract class BlockLattice extends BlockContainer implements IChainSingleAttachable {
   ...
   private final Vec3[] attachPoints = new Vec3[]{Vec3.createVectorHelper(0.5D, 0.5D, 0.5D), Vec3.createVectorHelper(0.5D, 0.5D, 0.5D), Vec3.createVectorHelper(0.5D, 0.5D, 0.5D), Vec3.createVectorHelper(0.5D, 0.5D, 0.5D), Vec3.createVectorHelper(0.5D, 0.5D, 0.5D), Vec3.createVectorHelper(0.5D, 0.5D, 0.5D)};
