...
public class BlockLatticeMetal extends BlockLattice {
    ...
    public IIcon getIcon(int side, int meta) {
        ...
        return protoBlock != null && protoBlock != this
            ? protoBlock.getIcon(side, TileEntityLatticeMetal.instance.getMetaFromComposedMetadata(meta))
            : this.icons[meta % this.icons.length];
    }
