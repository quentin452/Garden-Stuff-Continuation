...
public class BlockHoop extends Block implements IChainAttachable {
    ...
    private Vec3[] attachPoints = new Vec3[] { Vec3.createVectorHelper(0.03125D, 0.375D, 0.03125D),
        Vec3.createVectorHelper(0.03125D, 0.375D, 0.96875D), Vec3.createVectorHelper(0.96875D, 0.375D, 0.03125D),
        Vec3.createVectorHelper(0.96875D, 0.375D, 0.96875D) };
