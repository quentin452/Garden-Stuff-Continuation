...
public class GuiHandler implements IGuiHandler {
   ...
   public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
      ...
      return tile instanceof TileEntityBloomeryFurnace ? new ContainerBloomeryFurnace(player.inventory, (TileEntityBloomeryFurnace)tile) : null;
   }

   public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
      TileEntity tile = world.getTileEntity(x, y, z);
      return tile instanceof TileEntityBloomeryFurnace ? new GuiBloomeryFurnace(player.inventory, (TileEntityBloomeryFurnace)tile) : null;
   }
}
