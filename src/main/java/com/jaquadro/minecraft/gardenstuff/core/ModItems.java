...
public class ModItems {
   ...
   public void init() {
      ...
      ironNugget = (new Item()).setUnlocalizedName(makeName("ironNugget")).setCreativeTab(ModCreativeTabs.tabGardenCore).setTextureName("GardenStuff:iron_nugget");
      wroughtIronIngot = (new Item()).setUnlocalizedName(makeName("wroughtIronIngot")).setCreativeTab(ModCreativeTabs.tabGardenCore).setTextureName("GardenStuff:wrought_iron_ingot");
      wroughtIronNugget = (new Item()).setUnlocalizedName(makeName("wroughtIronNugget")).setCreativeTab(ModCreativeTabs.tabGardenCore).setTextureName("GardenStuff:wrought_iron_nugget");
      mossPaste = new ItemMossPaste(makeName("mossPaste"));
      candle = (new Item()).setUnlocalizedName(makeName("candle")).setCreativeTab(ModCreativeTabs.tabGardenCore).setTextureName("GardenStuff:candle");
