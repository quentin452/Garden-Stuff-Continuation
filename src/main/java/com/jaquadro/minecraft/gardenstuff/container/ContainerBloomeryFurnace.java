      ...
      if (slot != null && slot.getHasStack()) {
         ...
         if (slotIndex == this.outputSlot.slotNumber) {
            ...
            if (TileEntityBloomeryFurnace.isItemFuel(slotStack)) {
               merged = this.mergeItemStack(slotStack, this.fuelSlot.slotNumber, this.fuelSlot.slotNumber + 1, false);
            } else if (TileEntityBloomeryFurnace.isItemPrimaryInput(slotStack)) {
               merged = this.mergeItemStack(slotStack, this.primarySlot.slotNumber, this.primarySlot.slotNumber + 1, false);
            } else if (TileEntityBloomeryFurnace.isItemSecondaryInput(slotStack)) {
               merged = this.mergeItemStack(slotStack, this.secondarySlot.slotNumber, this.secondarySlot.slotNumber + 1, false);
            }
