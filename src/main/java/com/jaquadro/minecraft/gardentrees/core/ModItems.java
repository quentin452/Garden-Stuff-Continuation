...
public class ModItems {
   ...
   public void init() {
      candelilla_seeds = (new ItemSeeds(ModBlocks.candelilla)).setUnlocalizedName(makeName("candelillaSeeds")).setTextureName("GardenTrees:candelilla_seeds");
      candelilla = (new Item()).setUnlocalizedName(makeName("candelilla")).setCreativeTab(ModCreativeTabs.tabGardenTrees).setTextureName("GardenTrees:candelilla");
