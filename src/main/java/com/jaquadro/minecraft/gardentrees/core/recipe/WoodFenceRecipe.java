...
public class WoodFenceRecipe implements IRecipe {
      ...
      for(int row = 0; row < size - 1; ++row) {
         for(int col = 0; col < size - 2; ++col) {
            ...
            if (string1 != null && string2 != null && string1.getItem() == Items.string && string1.isItemEqual(string2)) {
               ...
               if (wood1 != null && wood2 != null && wood1.isItemEqual(wood2) && Block.getBlockFromItem(wood1.getItem()) == ModBlocks.thinLog) {
   ...
   public ItemStack getRecipeOutput() {
      return new ItemStack(ModBlocks.thinLogFence, 2, TileEntityWoodProxy.composeMetadata(this.woodType.getBlock(), this.woodType.meta));
   }
