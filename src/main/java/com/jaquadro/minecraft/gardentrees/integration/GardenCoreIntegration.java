...
public class GardenCoreIntegration {
   ...
   public static void init() {
      if (Loader.isModLoaded("GardenCore")) {
         ...
         saplingReg.putExtendedData(sapling, 0, "sm_generator", WorldGenStandardOrnTree.SmallOakTree.FACTORY.create(Blocks.log, 0, Blocks.leaves, 0));
         saplingReg.putExtendedData(sapling, 1, "sm_generator", WorldGenStandardOrnTree.SmallSpruceTree.FACTORY.create(Blocks.log, 1, Blocks.leaves, 1));
         saplingReg.putExtendedData(sapling, 2, "sm_generator", WorldGenStandardOrnTree.SmallOakTree.FACTORY.create(Blocks.log, 2, Blocks.leaves, 2));
         saplingReg.putExtendedData(sapling, 3, "sm_generator", WorldGenStandardOrnTree.SmallJungleTree.FACTORY.create(Blocks.log, 3, Blocks.leaves, 3));
         saplingReg.putExtendedData(sapling, 4, "sm_generator", WorldGenStandardOrnTree.SmallAcaciaTree.FACTORY.create(Blocks.log2, 0, Blocks.leaves2, 0));
         saplingReg.putExtendedData(sapling, 5, "sm_generator", WorldGenStandardOrnTree.SmallOakTree.FACTORY.create(Blocks.log2, 1, Blocks.leaves2, 1));
         ...
         saplingReg.putExtendedData(extSapling, 0, "sm_generator", WorldGenStandardOrnTree.SmallSpruceTree.FACTORY.create(Blocks.log, 1, Blocks.leaves, 1));
         saplingReg.putExtendedData(extSapling, 1, "sm_generator", WorldGenStandardOrnTree.SmallOakTree.FACTORY.create(Blocks.log, 0, Blocks.leaves, 0));
         saplingReg.putExtendedData(extSapling, 2, "sm_generator", WorldGenStandardOrnTree.SmallOakTree.FACTORY.create(Blocks.log, 2, Blocks.leaves, 2));
         GardenCoreAPI.instance().registerBonemealHandler(new GardenCoreIntegration.GardenBonemealHandler());
         WoodRegistry woodRegistry = WoodRegistry.instance();
         List woodList = OreDictionary.getOres("treeWood");
         Iterator var5 = woodList.iterator();
   ...
   private static class GardenBonemealHandler implements IBonemealHandler {
      ...
      // $FF: synthetic method
      GardenBonemealHandler(Object x0) {
         this();
      }
   }
}
