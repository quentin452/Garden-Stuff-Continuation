...
public class TwilightForestIntegration {
   ...
   public static void init() {
      if (Loader.isModLoaded("TwilightForest")) {
         ...
         plantReg.registerPlantInfo("TwilightForest", "tile.TFPlant", 3, new SimplePlantInfo(PlantType.GROUND_COVER, PlantSize.FULL));
         plantReg.registerPlantInfo("TwilightForest", "tile.TFPlant", 5, new SimplePlantInfo(PlantType.GROUND_COVER, PlantSize.FULL));
         plantReg.registerPlantInfo("TwilightForest", "tile.TFPlant", 13, new SimplePlantInfo(PlantType.HANGING, PlantSize.LARGE));
         plantReg.registerPlantInfo("TwilightForest", "tile.TFPlant", 14, new SimplePlantInfo(PlantType.HANGING, PlantSize.FULL));
         int[] var1 = new int[]{4};
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            i = var1[var3];
            plantReg.registerPlantInfo("TwilightForest", "tile.TFPlant", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
         }
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            i = var1[var3];
            plantReg.registerPlantInfo("TwilightForest", "tile.TFPlant", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.MEDIUM));
         }
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            i = var1[var3];
            plantReg.registerPlantInfo("TwilightForest", "tile.TFPlant", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE));
         }

         plantReg.registerPlantInfo("TwilightForest", "tile.TFSapling", new SimplePlantInfo(PlantType.GROUND, PlantSize.MEDIUM));
         var1 = new int[]{8, 9, 10, 11};
         var2 = var1.length;

         for(var3 = 0; var3 < var2; ++var3) {
            i = var1[var3];
            plantReg.registerPlantRenderer("TwilightForest", "tile.TFPlant", i, PlantRegistry.CROSSED_SQUARES_RENDERER);
         }
