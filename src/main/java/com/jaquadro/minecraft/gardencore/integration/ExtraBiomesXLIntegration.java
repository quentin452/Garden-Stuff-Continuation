...
public class ExtraBiomesXLIntegration {
    ...
    public static void init() {
        if (Loader.isModLoaded("ExtrabiomesXL")) {
            ...
            plantReg
                .registerPlantInfo("ExtrabiomesXL", "grass", new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE));
            plantReg.registerPlantInfo(
                "ExtrabiomesXL",
                "leaf_pile",
            ...
            plantReg
                .registerPlantInfo("ExtrabiomesXL", "plants4", new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL));
            plantReg.registerPlantInfo(
                "ExtrabiomesXL",
                "waterplant1",
                new SimplePlantInfo(PlantType.AQUATIC, PlantSize.FULL));
        }
    }
