...
public class GuiHandler implements IGuiHandler {
   ...
   public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
      ...
      if (tileEntity instanceof TileEntityGarden) {
         ...
         return tileEntity instanceof TileEntityCompostBin ? new ContainerCompostBin(player.inventory, (TileEntityCompostBin)tileEntity) : null;
      }
   }
   ...
   public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
      ...
      if (tileEntity instanceof TileEntityGarden) {
         ...
         return tileEntity instanceof TileEntityCompostBin ? new GuiCompostBin(player.inventory, (TileEntityCompostBin)tileEntity) : null;
      }
   }
   ...
   private Object openGardenGui(InventoryPlayer playerInventory, TileEntityGarden te, boolean client) {
      if (te == null) {
         ...
         return block == null ? null : block.getSlotProfile().openPlantGUI(playerInventory, te, client);
      }
   }
}
