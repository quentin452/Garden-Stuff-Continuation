...
public class GuiGardenLayout extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        ...
        String name = this.tileGarden.hasCustomInventoryName() ? this.tileGarden.getInventoryName()
            : I18n.format(this.tileGarden.getInventoryName(), new Object[0]);
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        if (!this.tileGarden
            .isAttachedNeighbor(this.tileGarden.xCoord - 1, this.tileGarden.yCoord, this.tileGarden.zCoord - 1)) {
            this.drawTexturedModalRect(guiX + 44, guiY + 18, 176, 0, 16, 16);
        }

        if (!this.tileGarden
            .isAttachedNeighbor(this.tileGarden.xCoord, this.tileGarden.yCoord, this.tileGarden.zCoord - 1)) {
        ...
        if (!this.tileGarden
            .isAttachedNeighbor(this.tileGarden.xCoord + 1, this.tileGarden.yCoord, this.tileGarden.zCoord)) {
    ...
    protected void drawSlotHighlight(Slot slot) {
        if (this.hoveredSlot != null && !this.isInPlayerInventory(this.hoveredSlot) && slot != this.hoveredSlot) {
            if (this.mc.thePlayer.inventory.getItemStack() == null && slot != null
                && slot.getHasStack()
                && this.hoveredSlot.isItemValid(slot.getStack())) {
                this.zLevel += 100.0F;
