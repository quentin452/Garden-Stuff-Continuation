...
public class GuiCompostBin extends GuiContainer {
    ...
    private static final ResourceLocation compostBinGuiTextures = new ResourceLocation(
        "gardencore",
        "textures/gui/compostBin.png");
    ...
    protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
        ...
        String name = this.tileCompost.hasCustomInventoryName() ? this.tileCompost.getInventoryName()
            : I18n.format(this.tileCompost.getInventoryName(), new Object[0]);
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
        ...
        this.mc.getTextureManager()
            .bindTexture(compostBinGuiTextures);
