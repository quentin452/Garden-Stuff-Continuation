...
public class Slot14Profile extends BasicSlotProfile {
    ...
    private static float[] plantOffsetX = new float[] { 0.0F, 0.0F, -0.252F, 0.25F, -0.25F, 0.252F, -0.5F, -0.001F,
        0.5F, 0.5F, 0.5F, -0.001F, -0.5F, -0.5F };
    private static float[] plantOffsetZ = new float[] { 0.0F, 0.0F, -0.25F, -0.252F, 0.252F, 0.25F, -0.501F, -0.5F,
        -0.501F, 0.0F, 0.449F, 0.5F, 0.449F, 0.0F };
    ...
    public Object openPlantGUI(InventoryPlayer playerInventory, TileEntity gardenTile, boolean client) {
        if (gardenTile instanceof TileEntityGarden) {
            return client ? new GuiGardenLayout(playerInventory, (TileEntityGarden) gardenTile)
                : new ContainerGarden(playerInventory, (TileEntityGarden) gardenTile);
        } else {
            return null;
        }
    }
