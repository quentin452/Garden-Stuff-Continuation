...
public class Slot14ProfileBounded extends Slot14Profile {
    ...
    private AxisAlignedBB[] boundS = new AxisAlignedBB[] {
        AxisAlignedBB.getBoundingBox(0.0D, 0.0D, 0.0D, 1.0D, 0.0625D, 0.6875D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.0625D, 0.0D, 1.0D, 0.125D, 0.75D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.125D, 0.0D, 1.0D, 1.0D, 0.8125D) };
    private AxisAlignedBB[] boundN = new AxisAlignedBB[] {
        AxisAlignedBB.getBoundingBox(0.0D, 0.0D, 0.3125D, 1.0D, 0.0625D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.0625D, 0.25D, 1.0D, 0.125D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.125D, 0.1875D, 1.0D, 1.0D, 1.0D) };
    private AxisAlignedBB[] boundE = new AxisAlignedBB[] {
        AxisAlignedBB.getBoundingBox(0.0D, 0.0D, 0.0D, 0.6875D, 0.0625D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.0625D, 0.0D, 0.75D, 0.125D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.125D, 0.0D, 0.8125D, 1.0D, 1.0D) };
    private AxisAlignedBB[] boundW = new AxisAlignedBB[] {
        AxisAlignedBB.getBoundingBox(0.3125D, 0.0D, 0.0D, 1.0D, 0.0625D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.25D, 0.0625D, 0.0D, 1.0D, 0.125D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.1875D, 0.125D, 0.0D, 1.0D, 1.0D, 1.0D) };
    private AxisAlignedBB[] boundSW = new AxisAlignedBB[] {
        AxisAlignedBB.getBoundingBox(0.3125D, 0.0D, 0.0D, 1.0D, 0.0625D, 0.6875D),
        AxisAlignedBB.getBoundingBox(0.25D, 0.0625D, 0.0D, 1.0D, 0.125D, 0.75D),
        AxisAlignedBB.getBoundingBox(0.1875D, 0.125D, 0.0D, 1.0D, 1.0D, 0.8125D) };
    private AxisAlignedBB[] boundSE = new AxisAlignedBB[] {
        AxisAlignedBB.getBoundingBox(0.0D, 0.0D, 0.0D, 0.6875D, 0.0625D, 0.6875D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.0625D, 0.0D, 0.75D, 0.125D, 0.75D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.125D, 0.0D, 0.8125D, 1.0D, 0.8125D) };
    private AxisAlignedBB[] boundNW = new AxisAlignedBB[] {
        AxisAlignedBB.getBoundingBox(0.3125D, 0.0D, 0.3125D, 1.0D, 0.0625D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.25D, 0.0625D, 0.25D, 1.0D, 0.125D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.1875D, 0.125D, 0.1875D, 1.0D, 1.0D, 1.0D) };
    private AxisAlignedBB[] boundNE = new AxisAlignedBB[] {
        AxisAlignedBB.getBoundingBox(0.0D, 0.0D, 0.3125D, 0.8125D, 0.0625D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.0625D, 0.25D, 0.75D, 0.125D, 1.0D),
        AxisAlignedBB.getBoundingBox(0.0D, 0.125D, 0.1875D, 0.8125D, 1.0D, 1.0D) };
