...
public class CompostRegistry implements ICompostRegistry {
    ...
    private void init() {
        ...
        this.registerCompostMaterial(
            (ItemStack) (new ItemStack(Items.string)),
            new StandardCompostMaterial(100, 0.0625F));
        this.registerCompostMaterial(
            (ItemStack) (new ItemStack(Items.wheat)),
            new StandardCompostMaterial(100, 0.125F));
        this.registerCompostMaterial(
            (ItemStack) (new ItemStack(Items.reeds)),
            new StandardCompostMaterial(150, 0.125F));
        this.registerCompostMaterial(
            (ItemStack) (new ItemStack(Items.feather)),
            new StandardCompostMaterial(50, 0.0625F));
        this.registerCompostMaterial(
    ...
    public ICompostMaterial getCompostMaterialInfo(ItemStack itemStack) {
        if (itemStack == null) {
            ...
            if (itemStack.getItem() instanceof ItemBlock) {
                ...
                for (Class clazz = itemStack.getItem()
                    .getClass(); clazz != null; clazz = clazz.getSuperclass()) {
                    if (this.classRegistry.containsKey(clazz)) {
                        return (ICompostMaterial) this.classRegistry.get(clazz);
                    }
