      ...
      for(int i = 0; i < this.registry.size(); ++i) {
         ...
         if (module.getModID() != null && !Loader.isModLoaded(module.getModID())) {
            ...
            try {
               ...
               this.registry.remove(i--);
               FMLLog.log("GardenStuff", Level.INFO, "Could not load integration module: " + module.getClass().getName() + " (init)", new Object[0]);
            }
         }
      }
   ...
   public void postInit() {
      for(int i = 0; i < this.registry.size(); ++i) {
         ...
         try {
            ...
            this.registry.remove(i--);
            FMLLog.log("GardenStuff", Level.INFO, "Could not load integration module: " + module.getClass().getName() + " (post-init)", new Object[0]);
         }
      }
