...
public class BiomesOPlenty extends IntegrationModule {
   ...
   public void init() throws Throwable {
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         i = var2[var4];
         plantReg.registerPlantInfo("BiomesOPlenty", "plants", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE));
      }

      plantReg.registerPlantInfo("BiomesOPlenty", "plants", 6, new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "plants", 7, new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL, 1, 2));
      plantReg.registerPlantInfo("BiomesOPlenty", "plants", 8, new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "plants", 10, new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL, 2, 2, new int[]{10, 9}));
      plantReg.registerPlantInfo("BiomesOPlenty", "plants", 11, new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "plants", 12, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
      plantReg.registerPlantInfo("BiomesOPlenty", "plants", 13, new SimplePlantInfo(PlantType.GROUND, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "plants", 14, new SimplePlantInfo(PlantType.AQUATIC_EMERGENT, PlantSize.FULL, 2, 2));
      plantReg.registerPlantInfo("BiomesOPlenty", "plants", 15, new SimplePlantInfo(PlantType.HANGING, PlantSize.LARGE));
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         i = var2[var4];
         plantReg.registerPlantInfo("BiomesOPlenty", "foliage", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE));
      }

      plantReg.registerPlantInfo("BiomesOPlenty", "foliage", 0, new SimplePlantInfo(PlantType.AQUATIC_COVER, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "foliage", 3, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE, 2, 2, new int[]{3, 6}));
      plantReg.registerPlantInfo("BiomesOPlenty", "foliage", 13, new SimplePlantInfo(PlantType.GROUND_COVER, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "foliage", 14, new SimplePlantInfo(PlantType.GROUND_COVER, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "foliage", 15, new SimplePlantInfo(PlantType.GROUND_COVER, PlantSize.FULL));
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         i = var2[var4];
         plantReg.registerPlantInfo("BiomesOPlenty", "flowers", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE));
      }

      plantReg.registerPlantInfo("BiomesOPlenty", "flowers", 0, new SimplePlantInfo(PlantType.GROUND_COVER, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "flowers", 2, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
      plantReg.registerPlantInfo("BiomesOPlenty", "flowers", 3, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
      plantReg.registerPlantInfo("BiomesOPlenty", "flowers", 5, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
      plantReg.registerPlantInfo("BiomesOPlenty", "flowers", 6, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
      plantReg.registerPlantInfo("BiomesOPlenty", "flowers", 10, new SimplePlantInfo(PlantType.AQUATIC_SURFACE, PlantSize.SMALL));
      plantReg.registerPlantInfo("BiomesOPlenty", "flowers", 13, new SimplePlantInfo(PlantType.GROUND, PlantSize.MEDIUM, 2, 2, new int[]{13, 14}));
      plantReg.registerPlantInfo("BiomesOPlenty", "flowers", 15, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         i = var2[var4];
         plantReg.registerPlantInfo("BiomesOPlenty", "flowers2", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE));
      }
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         i = var2[var4];
         plantReg.registerPlantInfo("BiomesOPlenty", "flowers2", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
      }

      plantReg.registerPlantRenderer("BiomesOPlenty", "flowers2", PlantRegistry.CROSSED_SQUARES_RENDERER);
      plantReg.registerPlantInfo("BiomesOPlenty", "coral1", 8, new SimplePlantInfo(PlantType.AQUATIC, PlantSize.LARGE, 2, 2, new int[]{8, 10}));
      plantReg.registerPlantInfo("BiomesOPlenty", "coral1", 11, new SimplePlantInfo(PlantType.AQUATIC, PlantSize.LARGE, 1, 2));
      plantReg.registerPlantInfo("BiomesOPlenty", "coral1", 12, new SimplePlantInfo(PlantType.AQUATIC, PlantSize.LARGE));
      plantReg.registerPlantInfo("BiomesOPlenty", "coral1", 13, new SimplePlantInfo(PlantType.AQUATIC, PlantSize.LARGE));
      plantReg.registerPlantInfo("BiomesOPlenty", "coral1", 14, new SimplePlantInfo(PlantType.AQUATIC, PlantSize.LARGE));
      plantReg.registerPlantInfo("BiomesOPlenty", "coral1", 15, new SimplePlantInfo(PlantType.AQUATIC, PlantSize.LARGE));
      plantReg.registerPlantInfo("BiomesOPlenty", "coral2", 8, new SimplePlantInfo(PlantType.AQUATIC, PlantSize.LARGE));
      ...
      plantReg.registerPlantInfo("BiomesOPlenty", "flowervine", new SimplePlantInfo(PlantType.HANGING_SIDE, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "moss", new SimplePlantInfo(PlantType.SIDE_COVER, PlantSize.FULL));
      plantReg.registerPlantInfo("BiomesOPlenty", "stoneFormations", 0, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE));
      plantReg.registerPlantInfo("BiomesOPlenty", "stoneFormations", 1, new SimplePlantInfo(PlantType.HANGING, PlantSize.LARGE));
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         i = var2[var4];
         plantReg.registerPlantInfo("BiomesOPlenty", "mushrooms", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
      }
