...
public final class PlantRegistry {
   ...
   private PlantRegistry() {
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         i = var2[var4];
         this.registerPlantInfo(Blocks.double_plant, i, new SimplePlantInfo(PlantType.GROUND, PlantSize.MEDIUM, 2, 2, new int[]{i, i | 8}));
      }
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         i = var2[var4];
         this.registerPlantInfo(Blocks.double_plant, i, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE, 2, 2, new int[]{i, i | 8}));
      }
