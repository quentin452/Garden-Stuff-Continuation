   ...
   public static void init() {
      if (Loader.isModLoaded("Natura")) {
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            i = var1[var3];
            plantReg.registerPlantInfo("Natura", "Glowshroom", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
         }
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            i = var1[var3];
            plantReg.registerPlantInfo("Natura", "Bluebells", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.MEDIUM));
         }
