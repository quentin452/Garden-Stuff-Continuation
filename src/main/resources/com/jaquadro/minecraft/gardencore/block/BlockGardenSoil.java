...
public class BlockGardenSoil extends BlockGarden {
   ...
   public void convertToFarm(World world, int x, int y, int z) {
      world.playSoundEffect((double)x + 0.5D, (double)y + 0.5D, (double)z + 0.5D, this.stepSound.getStepResourcePath(), (this.stepSound.getVolume() + 1.0F) / 2.0F, this.stepSound.getPitch() * 0.8F);
      if (!world.isRemote) {
