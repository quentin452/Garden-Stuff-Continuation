...
public class BlockSmallFire extends Block {
   ...
   public void randomDisplayTick(World world, int x, int y, int z, Random random) {
      if (random.nextInt(64) == 0) {
         world.playSound((double)((float)x + 0.5F), (double)((float)y + 0.5F), (double)((float)z + 0.5F), "fire.fire", 0.3F + random.nextFloat() * 0.5F, random.nextFloat() * 0.5F + 0.2F, false);
      }
   ...
   public void registerBlockIcons(IIconRegister register) {
      this.icons = new IIcon[]{register.registerIcon("GardenCore:" + this.getTextureName() + "_layer_0"), register.registerIcon("GardenCore:" + this.getTextureName() + "_layer_1")};
   }
