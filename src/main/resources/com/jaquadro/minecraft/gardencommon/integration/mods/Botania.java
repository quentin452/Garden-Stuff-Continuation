...
public class Botania extends IntegrationModule {
   ...
   public void init() throws Throwable {
      ...
      GardenCoreAPI.instance().registerBonemealHandler(new Botania.BonemealHandler());
      ...
      for(var6 = 0; var6 < var5; ++var6) {
         ...
         plantReg.registerPlantInfo("Botania", "shinyFlower", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.SMALL));
      }
      ...
      for(var6 = 0; var6 < var5; ++var6) {
         ...
         plantReg.registerPlantInfo("Botania", "shinyFlower", i, new SimplePlantInfo(PlantType.GROUND, PlantSize.LARGE));
      }

      plantReg.registerPlantInfo("Botania", "specialFlower", new SimplePlantInfo(PlantType.INVALID, PlantSize.MEDIUM));
   }
   ...
   private static class BonemealHandler implements IBonemealHandler {
      ...
      public boolean applyBonemeal(World world, int x, int y, int z, BlockGarden hostBlock, int slot) {
         ...
         if (block == flower) {
            ItemStack upgrade = (meta & 8) == 0 ? new ItemStack(Botania.flower1, 1, meta) : new ItemStack(Botania.flower2, 1, meta & 7);
