...
public class LatticeRenderer implements ISimpleBlockRenderingHandler {
   ...
   public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer) {
      ...
      this.boxRenderer.renderSolidBox((IBlockAccess)null, block, 0.0D, 0.0D, 0.0D, 0.0D, 0.4475D, 0.4475D, 1.0D, 0.5525D, 0.5525D);
      this.boxRenderer.renderSolidBox((IBlockAccess)null, block, 0.0D, 0.0D, 0.0D, 0.4475D, 0.0D, 0.4475D, 0.5525D, 1.0D, 0.5525D);
      GL11.glTranslatef(0.5F, 0.5F, 0.5F);
   }

   public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
      return !(block instanceof BlockLattice) ? false : this.renderWorldBlock(world, x, y, z, (BlockLattice)block, modelId, renderer);
   }
   ...
   public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, BlockLattice block, int modelId, RenderBlocks renderer) {
      ...
      this.boxRenderer.renderSolidBox(world, block, (double)x, (double)y, (double)z, 0.4375D, 0.4375D, 0.4375D, 0.5625D, 0.5625D, 0.5625D);
      ...
      if (yMin < 0.4375F) {
         this.boxRenderer.renderSolidBox(world, block, (double)x, (double)y, (double)z, 0.4375D, (double)yMin, 0.4375D, 0.5625D, 0.4375D, 0.5625D);
      }

      if (yMax > 0.5625F) {
         this.boxRenderer.renderSolidBox(world, block, (double)x, (double)y, (double)z, 0.4375D, 0.5625D, 0.4375D, 0.5625D, (double)yMax, 0.5625D);
      }

      float zMin = extZNeg ? -0.25F : (connectZNeg ? 0.0F : 0.4375F);
      float zMax = extZPos ? 1.25F : (connectZPos ? 1.0F : 0.5625F);
      if (zMin < 0.4375F) {
         this.boxRenderer.renderSolidBox(world, block, (double)x, (double)y, (double)z, 0.4375D, 0.4375D, (double)zMin, 0.5625D, 0.5625D, 0.4375D);
      }

      if (zMax > 0.5625F) {
         this.boxRenderer.renderSolidBox(world, block, (double)x, (double)y, (double)z, 0.4375D, 0.4375D, 0.5625D, 0.5625D, 0.5625D, (double)zMax);
      }

      float xMin = extXNeg ? -0.25F : (connectXNeg ? 0.0F : 0.4375F);
      float xMax = extXPos ? 1.25F : (connectXPos ? 1.0F : 0.5625F);
      if (xMin < 0.4375F) {
         this.boxRenderer.renderSolidBox(world, block, (double)x, (double)y, (double)z, (double)xMin, 0.4375D, 0.4375D, 0.4375D, 0.5625D, 0.5625D);
      }

      if (xMax > 0.5625F) {
         this.boxRenderer.renderSolidBox(world, block, (double)x, (double)y, (double)z, 0.5625D, 0.4375D, 0.4375D, (double)xMax, 0.5625D, 0.5625D);
      }
