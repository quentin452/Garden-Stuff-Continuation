...
public class ItemLantern extends ItemBlock {
   ...
   public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par4) {
      ...
      if (ModBlocks.lantern.isGlass(itemStack)) {
         contents = Blocks.stained_glass.getUnlocalizedName() + "." + ItemDye.field_150923_a[BlockColored.func_150032_b(itemStack.getItemDamage())];
         list.add(StatCollector.translateToLocal(contents + ".name"));
      }

      contents = StatCollector.translateToLocal(ModBlocks.makeName("lanternSource")) + ": " + EnumChatFormatting.YELLOW;
      ...
      if (lanternSource != null) {
         contents = contents + StatCollector.translateToLocal(lanternSource.getLanguageKey(itemStack.getItemDamage()));
      } else {
