...
public class VanillaLanternSource {
   public static class GlowstoneSource extends StandardLanternSource {
      public GlowstoneSource() {
         super(new StandardLanternSource.LanternSourceInfo("glowstone", Items.glowstone_dust, Blocks.glowstone.getLightValue()));
      }
   ...
   public static class RedstoneTorchSource extends StandardLanternSource implements IRedstoneSource {
      public RedstoneTorchSource() {
         super(new StandardLanternSource.LanternSourceInfo("redstoneTorch", Item.getItemFromBlock(Blocks.redstone_torch), Blocks.redstone_torch.getLightValue()));
      }
      ...
      public void renderItem(RenderBlocks renderer, ItemRenderType renderType, int meta) {
         ...
         renderHelper.renderFace(2, (IBlockAccess)null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(2, 0), meta);
         renderHelper.renderFace(3, (IBlockAccess)null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(3, 0), meta);
         renderHelper.setRenderBounds(0.4375D, 0.0D, 0.0D, 0.5625D, 1.0D, 1.0D);
         renderHelper.renderFace(4, (IBlockAccess)null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(4, 0), meta);
         renderHelper.renderFace(5, (IBlockAccess)null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(5, 0), meta);
         renderHelper.setRenderBounds(0.4375D, 0.0D, 0.4375D, 0.5625D, 0.625D, 0.5625D);
         renderHelper.renderFace(1, (IBlockAccess)null, Blocks.redstone_torch, Blocks.redstone_torch.getIcon(1, 0), meta);
      }
   ...
   public static class TorchLanternSource extends StandardLanternSource {
      public TorchLanternSource() {
         super(new StandardLanternSource.LanternSourceInfo("torch", Item.getItemFromBlock(Blocks.torch), Blocks.torch.getLightValue()));
      }
