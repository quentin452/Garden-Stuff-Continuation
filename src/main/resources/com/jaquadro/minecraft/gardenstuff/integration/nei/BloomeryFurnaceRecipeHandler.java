...
public class BloomeryFurnaceRecipeHandler extends TemplateRecipeHandler {
   ...
   public void loadCraftingRecipes(String outputId, Object... results) {
      if (outputId.equals("bloomerySmelting") && this.getClass() == BloomeryFurnaceRecipeHandler.class) {
         this.arecipes.add(new BloomeryFurnaceRecipeHandler.SmeltingPair(new ItemStack(Items.iron_ingot), new ItemStack(Blocks.sand), new ItemStack(ModItems.wroughtIronIngot)));
         this.arecipes.add(new BloomeryFurnaceRecipeHandler.SmeltingPair(new ItemStack(Blocks.iron_ore), new ItemStack(Blocks.sand), new ItemStack(ModItems.wroughtIronIngot)));
      } else {
   ...
   public void loadUsageRecipes(ItemStack ingredient) {
      ...
      for(var6 = 0; var6 < var5; ++var6) {
         ...
         if (NEIServerUtils.areStacksSameTypeCrafting(stack, ingredient)) {
            ...
            for(var10 = 0; var10 < var9; ++var10) {
               ...
               arecipe = new BloomeryFurnaceRecipeHandler.SmeltingPair(stack, primaryStack, new ItemStack(ModItems.wroughtIronIngot));
      ...
      for(var6 = 0; var6 < var5; ++var6) {
         ...
         if (NEIServerUtils.areStacksSameTypeCrafting(stack, ingredient)) {
            ...
            for(var10 = 0; var10 < var9; ++var10) {
               primaryStack = var8[var10];
               arecipe = new BloomeryFurnaceRecipeHandler.SmeltingPair(primaryStack, stack, new ItemStack(ModItems.wroughtIronIngot));
   ...
   public class SmeltingPair extends CachedRecipe {
      ...
      public PositionedStack getOtherStack() {
         return ((BloomeryFurnaceRecipeHandler.FuelPair)BloomeryFurnaceRecipeHandler.afuels.get(BloomeryFurnaceRecipeHandler.this.cycleticks / 48 % BloomeryFurnaceRecipeHandler.afuels.size())).stack;
      }
   }
