   ...
   public void updateEntity() {
      ...
      if (!this.worldObj.isRemote) {
         ...
         if (hasPrevBurnTime != this.furnaceBurnTime > 0) {
            isDirty = true;
            BlockBloomeryFurnace.updateFurnaceBlockState(this.worldObj, this.xCoord, this.yCoord, this.zCoord, this.furnaceBurnTime > 0);
         }
      }
      ...
      if (this.furnaceItemStacks[0] != null && this.furnaceItemStacks[1] != null) {
         if (!isItemPrimaryInput(this.furnaceItemStacks[0])) {
            ...
            if (this.furnaceItemStacks[3] == null) {
               ...
               return result <= this.getInventoryStackLimit() && result <= this.furnaceItemStacks[3].getMaxStackSize();
            }
         }
      } else {
         return false;
