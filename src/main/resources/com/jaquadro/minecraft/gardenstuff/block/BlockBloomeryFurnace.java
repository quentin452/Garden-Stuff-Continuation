...
public class BlockBloomeryFurnace extends BlockContainer {
   ...
   public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
      ...
      if ((meta & 8) != 0) {
         ...
         switch(dir) {
         case 2:
            world.spawnParticle("smoke", (double)(fx + adjust), (double)fy, (double)(fz - depth), 0.0D, 0.0D, 0.0D);
            world.spawnParticle("flame", (double)(fx + adjust), (double)fy, (double)(fz - depth), 0.0D, 0.0D, 0.0D);
            break;
         case 3:
            world.spawnParticle("smoke", (double)(fx + adjust), (double)fy, (double)(fz + depth), 0.0D, 0.0D, 0.0D);
            world.spawnParticle("flame", (double)(fx + adjust), (double)fy, (double)(fz + depth), 0.0D, 0.0D, 0.0D);
            break;
         case 4:
            world.spawnParticle("smoke", (double)(fx - depth), (double)fy, (double)(fz + adjust), 0.0D, 0.0D, 0.0D);
            world.spawnParticle("flame", (double)(fx - depth), (double)fy, (double)(fz + adjust), 0.0D, 0.0D, 0.0D);
            break;
         case 5:
            world.spawnParticle("smoke", (double)(fx + depth), (double)fy, (double)(fz + adjust), 0.0D, 0.0D, 0.0D);
            world.spawnParticle("flame", (double)(fx + depth), (double)fy, (double)(fz + adjust), 0.0D, 0.0D, 0.0D);
