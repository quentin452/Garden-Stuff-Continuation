...
@Interface(
   iface = "thaumcraft.api.crafting.IInfusionStabiliser",
   modid = "Thaumcraft",
   striprefs = true
)
public class BlockLantern extends BlockContainer implements IInfusionStabiliser {
      ...
      if (tile == null) {
         ...
         if (item == null && player.isSneaking() && tile.getLightSource() != null) {
            ...
            if (tile.getLightSource() == null && item != null) {
               Iterator var12 = Api.instance.registries.lanternSources.getAllLanternSources().iterator();
   ...
   public boolean canStabaliseInfusion(World world, int x, int y, int z) {
      ...
      if (tile == null) {
         ...
         ILanternSource lanternSource = Api.instance.registries().lanternSources().getLanternSource(tile.getLightSource());
         return lanternSource == null ? false : lanternSource.getSourceID().equals("thaumcraftCandle");
      }
   }
}
