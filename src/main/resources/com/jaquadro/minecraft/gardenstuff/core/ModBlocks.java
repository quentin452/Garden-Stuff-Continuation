...
public class ModBlocks {
   ...
   public void init() {
      ...
      metalBlock = (new BlockCompressed(MapColor.blackColor)).setBlockName(makeName("metalBlock")).setCreativeTab(ModCreativeTabs.tabGardenCore).setBlockTextureName("GardenStuff:wrought_iron_block").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeMetal);
