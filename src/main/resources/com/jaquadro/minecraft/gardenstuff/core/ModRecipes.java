...
public class ModRecipes {
   private static String[] paneGlassOreDict = new String[]{"paneGlassBlack", "paneGlassRed", "paneGlassGreen", "paneGlassBrown", "paneGlassBlue", "paneGlassPurple", "paneGlassCyan", "paneGlassLightGray", "paneGlassGray", "paneGlassPink", "paneGlassLime", "paneGlassYellow", "paneGlassLightBlue", "paneGlassMagenta", "paneGlassOrange", "paneGlassWhite"};
   ...
   public void init() {
      ...
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.heavyChain, 4, 0), new Object[]{"xx", "xx", "xx", 'x', linkIron});
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.heavyChain, 4, 1), new Object[]{"xx", "xx", "xx", 'x', linkGold});
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.heavyChain, 4, 4), new Object[]{"xx", "xx", "xx", 'x', linkWroughtIron});
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.heavyChain, 8, 5), new Object[]{"xxx", "xyx", "xxx", 'x', heavyChainIron, 'y', vine});
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.lightChain, 2, 0), new Object[]{"x", "x", "x", 'x', linkIron});
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.lightChain, 2, 1), new Object[]{"x", "x", "x", 'x', linkGold});
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.lightChain, 2, 4), new Object[]{"x", "x", "x", 'x', linkWroughtIron});
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.lightChain, 8, 5), new Object[]{"xxx", "xyx", "xxx", 'x', lightChainIron, 'y', vine});
      ...
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.latticeMetal, 8, 3), new Object[]{"xxx", "xyx", "xxx", 'x', latticeIron, 'y', vine});
      GameRegistry.addShapedRecipe(new ItemStack(Items.iron_ingot), new Object[]{"xxx", "xxx", "xxx", 'x', ironNugget});
      GameRegistry.addShapedRecipe(new ItemStack(ModItems.ironNugget, 9), new Object[]{"x", 'x', new ItemStack(Items.iron_ingot)});
      GameRegistry.addShapedRecipe(blockCharcoal, new Object[]{"xxx", "xxx", "xxx", 'x', new ItemStack(Items.coal, 1, 1)});
      ...
      GameRegistry.addShapedRecipe(new ItemStack(ModItems.wroughtIronIngot, 9), new Object[]{"x", 'x', blockWroughtIron});
      GameRegistry.addShapedRecipe(wroughtIronIngot, new Object[]{"xxx", "xxx", "xxx", 'x', wroughtIronNugget});
      GameRegistry.addShapedRecipe(new ItemStack(ModItems.wroughtIronNugget, 9), new Object[]{"x", 'x', wroughtIronIngot});
      ...
      GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.bloomeryFurnace), new Object[]{"xxx", "xyx", "xxx", 'x', Items.brick, 'y', new ItemStack(Blocks.furnace)});
      ...
      for(i = 0; i < 16; ++i) {
         ...
         GameRegistry.addRecipe(new ShapedOreRecipe(target, new Object[]{" x ", "yzy", "yxy", 'x', "ingotWroughtIron", 'y', new ItemStack(ModBlocks.fence, 1, 0), 'z', paneGlassOreDict[15 - i]}));
         target = ((ItemLantern)Item.getItemFromBlock(ModBlocks.lantern)).makeItemStack(1, i, true);
         GameRegistry.addRecipe(new ShapelessOreRecipe(target, new Object[]{new ItemStack(ModBlocks.lantern, 1, 0), paneGlassOreDict[15 - i]}));
      }

      for(i = 0; i < 6; ++i) {
         GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.latticeWood, 8, i), new Object[]{" x ", "xxx", " x ", 'x', new ItemStack(Blocks.planks, 1, i)});
      }

      GameRegistry.addRecipe(new ItemStack(ModItems.mossPaste), new Object[]{"xyx", "yxy", "xyx", 'x', Blocks.vine, 'y', Items.clay_ball});
      GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.candle, 4, 0), new Object[]{"x", "y", "y", 'x', Items.string, 'y', "materialWax"}));
      GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModItems.candle, 4, 0), new Object[]{"x", "y", "y", 'x', Items.string, 'y', "materialPressedwax"}));
