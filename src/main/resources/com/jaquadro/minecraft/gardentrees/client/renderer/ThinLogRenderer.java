...
public class ThinLogRenderer implements ISimpleBlockRenderingHandler {
   ...
   public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
      return !(block instanceof BlockThinLog) ? false : this.renderWorldBlock(world, x, y, z, (BlockThinLog)block, modelId, renderer);
   }
   ...
   private boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, BlockThinLog block, int modelId, RenderBlocks renderer) {
      ...
      if ((!connectYNeg || !connectYPos) && (!connectZNeg || !connectZPos) && (!connectXNeg || !connectXPos)) {
         ...
         renderer.setRenderBounds((double)margin, (double)margin, (double)margin, (double)(1.0F - margin), (double)(1.0F - margin), (double)(1.0F - margin));
      ...
      if (connectY) {
         ...
         if (connectYNeg && connectYPos) {
            renderer.setRenderBounds((double)margin, 0.0D, (double)margin, (double)(1.0F - margin), 1.0D, (double)(1.0F - margin));
         } else if (connectYNeg) {
            renderer.setRenderBounds((double)margin, 0.0D, (double)margin, (double)(1.0F - margin), (double)margin, (double)(1.0F - margin));
         } else if (connectYPos) {
            renderer.setRenderBounds((double)margin, (double)(1.0F - margin), (double)margin, (double)(1.0F - margin), 1.0D, (double)(1.0F - margin));
         }
      ...
      if (connectZ) {
         ...
         if (connectZNeg && connectZPos) {
            renderer.setRenderBounds((double)margin, (double)margin, 0.0D, (double)(1.0F - margin), (double)(1.0F - margin), 1.0D);
         } else if (connectZNeg) {
            renderer.setRenderBounds((double)margin, (double)margin, 0.0D, (double)(1.0F - margin), (double)(1.0F - margin), (double)margin);
         } else if (connectZPos) {
            renderer.setRenderBounds((double)margin, (double)margin, (double)(1.0F - margin), (double)(1.0F - margin), (double)(1.0F - margin), 1.0D);
         }
      ...
      if (connectX) {
         ...
         if (connectXNeg && connectXPos) {
            renderer.setRenderBounds(0.0D, (double)margin, (double)margin, 1.0D, (double)(1.0F - margin), (double)(1.0F - margin));
         } else if (connectXNeg) {
            renderer.setRenderBounds(0.0D, (double)margin, (double)margin, (double)margin, (double)(1.0F - margin), (double)(1.0F - margin));
         } else if (connectXPos) {
            renderer.setRenderBounds((double)(1.0F - margin), (double)margin, (double)margin, 1.0D, (double)(1.0F - margin), (double)(1.0F - margin));
         }
      ...
      if (blockUnder instanceof BlockGarden) {
         ...
         if (yDiff >= 1.875F) {
            renderer.setRenderBounds((double)margin, (double)yDiff, (double)margin, (double)(1.0F - margin), 1.0D, (double)(1.0F - margin));
