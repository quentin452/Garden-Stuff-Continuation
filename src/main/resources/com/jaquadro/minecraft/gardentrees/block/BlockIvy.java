...
public class BlockIvy extends Block implements IShearable {
         ...
         if (dz == 1 && y < 255 && world.isAirBlock(x, y + 1, z)) {
            ...
            if (chance > 0) {
               for(opSide = 0; opSide <= 3; ++opSide) {
                  ...
                  if (!this.canPlaceOnBlock(world, x + Direction.offsetX[opSide], y + 1, z + Direction.offsetZ[opSide], dirRight)) {
                     chance &= ~(1 << opSide);
                  }
               }
            ...
            if (block.getMaterial() == Material.air) {
               ...
               if ((meta & 1 << dirRight) != 0 && this.canPlaceOnBlock(world, x + Direction.offsetX[facingDir] + Direction.offsetX[dirRight], y, z + Direction.offsetZ[facingDir] + Direction.offsetZ[dirRight], opSideRight)) {
                  world.setBlock(x + Direction.offsetX[facingDir], y, z + Direction.offsetZ[facingDir], this, 1 << dirRight, 2);
               } else if ((meta & 1 << dirLeft) != 0 && this.canPlaceOnBlock(world, x + Direction.offsetX[facingDir] + Direction.offsetX[dirLeft], y, z + Direction.offsetZ[facingDir] + Direction.offsetZ[dirLeft], opSideLeft)) {
                  world.setBlock(x + Direction.offsetX[facingDir], y, z + Direction.offsetZ[facingDir], this, 1 << dirLeft, 2);
               } else if ((meta & 1 << dirRight) != 0 && world.isAirBlock(x + Direction.offsetX[facingDir] + Direction.offsetX[dirRight], y, z + Direction.offsetZ[facingDir] + Direction.offsetZ[dirRight]) && this.canPlaceOnBlock(world, x + Direction.offsetX[dirRight], y, z + Direction.offsetZ[dirRight], opSide)) {
               ...
               } else if ((meta & 1 << dirLeft) != 0 && world.isAirBlock(x + Direction.offsetX[facingDir] + Direction.offsetX[dirLeft], y, z + Direction.offsetZ[facingDir] + Direction.offsetZ[dirLeft]) && this.canPlaceOnBlock(world, x + Direction.offsetX[dirLeft], y, z + Direction.offsetZ[dirLeft], opSide)) {
            ...
            } else if (this.canPlaceOnBlock(world, x + Direction.offsetX[facingDir], y, z + Direction.offsetZ[facingDir], opSide)) {
   ...
   private boolean isBlockStateValid(World world, int x, int y, int z) {
      ...
      if (meta > 0) {
         for(int i = 0; i <= 3; ++i) {
            ...
            if ((meta & bit) != 0 && !this.canPlaceOnBlock(world, x + Direction.offsetX[i], y, z + Direction.offsetZ[i], opSide) && (world.getBlock(x, y + 1, z) != this || (world.getBlockMetadata(x, y + 1, z) & bit) == 0)) {
               mask &= ~bit;
            }
         }
      }
   ...
   public IIcon getIcon(IBlockAccess blockAccess, int x, int y, int z, int side) {
      ...
      switch(side) {
      case 2:
         nLeft = (meta & 8) != 0 || blockAccess.getBlock(x + 1, y, z) == this && (blockAccess.getBlockMetadata(x + 1, y, z) & 1) != 0 || blockAccess.getBlock(x + 1, y, z + 1) == this && (blockAccess.getBlockMetadata(x + 1, y, z + 1) & 2) != 0;
         nRight = (meta & 2) != 0 || blockAccess.getBlock(x - 1, y, z) == this && (blockAccess.getBlockMetadata(x - 1, y, z) & 1) != 0 || blockAccess.getBlock(x - 1, y, z + 1) == this && (blockAccess.getBlockMetadata(x - 1, y, z + 1) & 8) != 0;
         break;
      case 3:
         nLeft = (meta & 2) != 0 || blockAccess.getBlock(x - 1, y, z) == this && (blockAccess.getBlockMetadata(x - 1, y, z) & 4) != 0 || blockAccess.getBlock(x - 1, y, z - 1) == this && (blockAccess.getBlockMetadata(x - 1, y, z - 1) & 8) != 0;
         nRight = (meta & 8) != 0 || blockAccess.getBlock(x + 1, y, z) == this && (blockAccess.getBlockMetadata(x + 1, y, z) & 4) != 0 || blockAccess.getBlock(x + 1, y, z - 1) == this && (blockAccess.getBlockMetadata(x + 1, y, z - 1) & 2) != 0;
         break;
      case 4:
         nLeft = (meta & 4) != 0 || blockAccess.getBlock(x, y, z - 1) == this && (blockAccess.getBlockMetadata(x, y, z - 1) & 8) != 0 || blockAccess.getBlock(x + 1, y, z - 1) == this && (blockAccess.getBlockMetadata(x + 1, y, z - 1) & 1) != 0;
         nRight = (meta & 1) != 0 || blockAccess.getBlock(x, y, z + 1) == this && (blockAccess.getBlockMetadata(x, y, z + 1) & 8) != 0 || blockAccess.getBlock(x + 1, y, z + 1) == this && (blockAccess.getBlockMetadata(x + 1, y, z + 1) & 4) != 0;
         break;
      case 5:
         nLeft = (meta & 1) != 0 || blockAccess.getBlock(x, y, z + 1) == this && (blockAccess.getBlockMetadata(x, y, z + 1) & 2) != 0 || blockAccess.getBlock(x - 1, y, z + 1) == this && (blockAccess.getBlockMetadata(x - 1, y, z + 1) & 4) != 0;
         nRight = (meta & 4) != 0 || blockAccess.getBlock(x, y, z - 1) == this && (blockAccess.getBlockMetadata(x, y, z - 1) & 2) != 0 || blockAccess.getBlock(x - 1, y, z - 1) == this && (blockAccess.getBlockMetadata(x - 1, y, z - 1) & 1) != 0;
      }
