      ...
      if (te != null) {
         for(int i = 0; i < te.getSizeInventory(); ++i) {
            ...
            if (stack != null) {
               ...
               EntityItem entity;
               for(float ez = this.rand.nextFloat() * 0.8F + 0.1F; stack.stackSize > 0; world.spawnEntityInWorld(entity)) {
                  ...
                  entity = new EntityItem(world, (double)((float)x + ex), (double)((float)y + ey), (double)((float)z + ez), new ItemStack(stack.getItem(), stackPartSize, stack.getItemDamage()));
