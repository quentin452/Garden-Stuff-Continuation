...
@Interface(
   modid = "AgriCraft",
   iface = "com.InfinityRaider.AgriCraft.api.v1.ISoilContainer"
)
public abstract class BlockLargePot extends BlockGardenContainer implements IChainAttachable, ISoilContainer {
   ...
   private static final Vec3[] chainAttachPoints = new Vec3[]{Vec3.createVectorHelper(0.03625D, 1.0D, 0.03125D), Vec3.createVectorHelper(0.03125D, 1.0D, 0.96375D), Vec3.createVectorHelper(0.96875D, 1.0D, 0.03625D), Vec3.createVectorHelper(0.96375D, 1.0D, 0.96875D)};
   ...
   public BlockLargePot(String blockName) {
      ...
      this.slotProfile = new BlockLargePot.LocalSlotProfile(this, new BasicSlotProfile.Slot[]{new BasicSlotProfile.Slot(0, commonType, allSize), new BasicSlotProfile.Slot(1, new PlantType[]{PlantType.GROUND_COVER}, allSize), new BasicSlotProfile.Slot(2, commonType, commonSize), new BasicSlotProfile.Slot(3, commonType, commonSize), new BasicSlotProfile.Slot(4, commonType, commonSize), new BasicSlotProfile.Slot(5, commonType, commonSize), new BasicSlotProfile.Slot(6, commonType, commonSize), new BasicSlotProfile.Slot(7, commonType, commonSize), new BasicSlotProfile.Slot(8, commonType, commonSize), new BasicSlotProfile.Slot(9, commonType, commonSize), new BasicSlotProfile.Slot(10, commonType, commonSize), new BasicSlotProfile.Slot(11, commonType, commonSize), new BasicSlotProfile.Slot(12, commonType, commonSize), new BasicSlotProfile.Slot(13, commonType, commonSize)});
   }
   ...
   public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB mask, List list, Entity colliding) {
      ...
      if (te != null && te.getSubstrate() != null && this.isSubstrateSolid(te.getSubstrate().getItem())) {
   ...
   public Block getSoil(World world, int x, int y, int z) {
      ...
      return substrate != null && substrate.getItem() != null && substrate.getItem() instanceof ItemBlock ? ((ItemBlock)substrate.getItem()).field_150939_a : null;
   }

   public int getSoilMeta(World world, int x, int y, int z) {
      ItemStack substrate = this.getGardenSubstrate(world, x, y, z, this.getDefaultSlot());
      return substrate != null && substrate.getItem() != null && substrate.getItem() instanceof ItemBlock ? substrate.getItemDamage() : -1;
   }
   ...
   private class LocalSlotProfile extends Slot14ProfileBounded {
      ...
      public Object openPlantGUI(InventoryPlayer playerInventory, TileEntity gardenTile, boolean client) {
         return gardenTile instanceof TileEntityGarden && ((TileEntityGarden)gardenTile).getSubstrate() == null ? null : super.openPlantGUI(playerInventory, gardenTile, client);
      }
   }
}
