...
public class ItemPotteryPatternDirty extends Item {
   ...
   public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par4) {
      String[] var5 = StatCollector.translateToLocal("item.gardencontainers.potteryPatternDirty.description").split("\\\\n");
            ...
            if (waterLevel == 0) {
               ...
               if (index == -1) {
                  ...
                  if (pattern == null) {
                     ...
                     --itemStack.stackSize;
                     world.spawnEntityInWorld(new EntityItem(world, (double)x + 0.5D, (double)y + 1.5D, (double)z + 0.5D, stamp));
                     return true;
                  }
               }
            }
